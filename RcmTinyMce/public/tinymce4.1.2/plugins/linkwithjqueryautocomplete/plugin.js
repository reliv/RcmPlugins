...
tinymce.PluginManager.add('linkwithjqueryautocomplete', function (editor) {
    ...
    function showDialog(linkList) {
        ...
        if (linkList) {
            //REMOVED FOR JQUERY AUTO-COMPLETE FUNCTIONALITY
//            linkListCtrl = {
//                type: 'listbox',
//                label: 'Link list',
...
//				linkListCtrl, //REMOVED FOR JQUERY AUTO-COMPLETE FUNCTIONALITY
                relListCtrl,
                targetListCtrl,
                classListCtrl
            ],
        ...
        //ADDED FOR JQUERY AUTO-COMPLETE FUNCTIONALITY
        var autoCompleteLinkList = [];
        $.each(linkList, function () {
            autoCompleteLinkList.push(this.value);
        });
        var urlInput = $('#' + win.find('#href')[0]._id + '-inp');
        urlInput.autocomplete({
            source: autoCompleteLinkList,
            minLength: 0
        });
