/**
 * This finds any form with attribute data-form-double-submit-protect and ensures that each
 * form can only be submitted once and shows that it is loading via css.
 *
 * setTimeout(func,0) is similar to $.ready()
 */
setTimeout(function () {
    var forms = document.querySelectorAll("form[data-form-double-submit-protect]");
