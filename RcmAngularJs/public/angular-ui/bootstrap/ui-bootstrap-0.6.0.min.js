        ...
        return function (i, p, d) {
            ...
            return{restrict: "EA", scope: !0, link: function (e, t, n) {
                ...
                function g() {
                    var n, a, i, r;
                    if (e.tt_content) {
                        switch (v && o.cancel(v), w.css({top: 0, left: 0, display: "block"}), k ? (y = y || c.find("body"), y.append(w)) : t.after(w), n = k ? s.offset(t) : s.position(t), a = w.prop("offsetWidth"), i = w.prop("offsetHeight"), e.tt_placement) {
                            case"right":
                ...
                g(c, !0), n.when(b.source(w, t)).then(function (n) {
                    if (e === p.$viewValue) {
                        if (n.length > 0) {
                            ...
                            for (var a = 0; n.length > a; a++)t[b.itemName] = n[a], w.matches.push({label: b.viewMapper(w, t), model: n[a]});
