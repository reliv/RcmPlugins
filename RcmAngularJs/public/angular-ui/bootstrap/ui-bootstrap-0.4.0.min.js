angular.module("ui.bootstrap", ["ui.bootstrap.transition", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.datepicker", "ui.bootstrap.dialog", "ui.bootstrap.dropdownToggle", "ui.bootstrap.modal", "ui.bootstrap.pagination", "ui.bootstrap.position", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.transition", []).factory("$transition", ["$q", "$timeout", "$rootScope", function (e, t, n) {
    ...
    var o = function (a, i, r) {
        r = r || {};
        var l = e.defer(), s = o[r.animation ? "animationEndEventName" : "transitionEndEventName"], u = function () {
            n.$apply(function () {
                a.unbind(s, u), l.resolve(a)
            })
        };
        return s && a.bind(s, u), t(function () {
            ...
            s && a.unbind(s, u), l.reject("Transition cancelled")
        }, l.promise
    ...
    return{restrict: "EA", templateUrl: "template/alert/alert.html", transclude: !0, replace: !0, scope: {type: "=", close: "&"}, link: function (e, t, n) {
        ...
        r.currentSlide = null, r.select = function (o, i) {
            function u() {
                ...
                }(o, r.currentSlide)) : c(o, r.currentSlide), r.currentSlide = o, s = p, a()
            }
            ...
            var p = l.indexOf(o);
            void 0 === i && (i = p > s ? "next" : "prev"), o && o !== r.currentSlide && (e.$currentTransition ? (e.$currentTransition.cancel(), t(u)) : u())
    ...
    return{restrict: "EA", replace: !0, scope: {model: "=ngModel", dateDisabled: "&"}, templateUrl: "template/datepicker/datepicker.html", link: function (a, o, r) {
        ...
        a.mode = "day";
        var p, d, f, m = new Date, g = {};
        g.day = angular.isDefined(r.dayFormat) ? a.$eval(r.dayFormat) : n.dayFormat, g.month = angular.isDefined(r.monthFormat) ? a.$eval(r.monthFormat) : n.monthFormat, g.year = angular.isDefined(r.yearFormat) ? a.$eval(r.yearFormat) : n.yearFormat, g.dayHeader = angular.isDefined(r.dayHeaderFormat) ? a.$eval(r.dayHeaderFormat) : n.dayHeaderFormat, g.dayTitle = angular.isDefined(r.dayTitleFormat) ? a.$eval(r.dayTitleFormat) : n.dayTitleFormat, g.monthTitle = angular.isDefined(r.monthTitleFormat) ? a.$eval(r.monthTitleFormat) : n.monthTitleFormat;
        ...
        var $ = function (e, t) {
            ...
            function t(t, a, i) {
                for (var r = 0; a > r; r++)n.push({date: new Date(t), isCurrent: i, isSelected: k(t), label: e(t, g.day), disabled: c(t)}), t.setDate(t.getDate() + 1);
                o = t
            }

            var n = [], a = [], o = null, r = new Date(m);
            r.setDate(1);
            var s = h - r.getDay(), u = s > 0 ? 7 - s : -s;
            for (u > 0 && (r.setDate(-u + 1), t(r, u, !1)), t(o || r, b(m.getFullYear(), m.getMonth()), !0), t(o, (7 - n.length % 7) % 7, !1), i = 0; 7 > i; i++)a.push(e(n[i].date, g.dayHeader));
            l($(n, 7), a, e(m, g.dayTitle))
        }, month: function () {
            for (var t = [], n = 0, a = m.getFullYear(); 12 > n;) {
                var o = new Date(a, n++, 1);
                t.push({date: o, isCurrent: !0, isSelected: k(o), label: e(o, g.month), disabled: c(o)})
            }
            l($(t, 3), [], e(m, g.monthTitle))
        }, year: function () {
            for (var t = [], n = parseInt((m.getFullYear() - 1) / v, 10) * v + 1, a = 0; v > a; a++) {
                var o = new Date(n + a, 0, 1);
                t.push({date: o, isCurrent: !0, isSelected: k(o), label: e(o, g.year), disabled: c(o)})
            }
        ...
        a.$watch("model", function (e, t) {
            angular.isDate(e) && (m = angular.copy(e)), angular.equals(e, t) || w()
        }), a.$watch("mode", function () {
            s(), w()
        }), a.select = function (e) {
            m = new Date(e), "year" === a.mode ? (a.mode = "month", m.setFullYear(e.getFullYear())) : "month" === a.mode ? (a.mode = "day", m.setMonth(e.getMonth())) : "day" === a.mode && (a.model = new Date(m))
        }, a.move = function (e) {
            "day" === a.mode ? m.setMonth(m.getMonth() + e) : "month" === a.mode ? m.setFullYear(m.getFullYear() + e) : "year" === a.mode && m.setFullYear(m.getFullYear() + e * v), w()
...
dialogModule.controller("MessageBoxController", ["$scope", "dialog", "model", function (e, t, n) {
    ...
    this.options = function (e) {
        t = e
    }, this.$get = ["$http", "$document", "$compile", "$rootScope", "$controller", "$templateCache", "$q", "$transition", "$injector", function (a, o, i, r, l, s, u, c, p) {
        function d(e) {
        ...
        return f.prototype.isOpen = function () {
            ...
            }), this.deferred = u.defer(), this.deferred.promise
            ...
            if (o.length > 0)for (var i = o.length - 1; i >= 0; i--)c(o[i], t).then(n); else this._onCloseComplete(e)
            ...
            var e, t = [], n = [], o = this;
            return this.options.template ? e = u.when(this.options.template) : this.options.templateUrl && (e = a.get(this.options.templateUrl, {cache: s}).then(function (e) {
                return e.data
            })), angular.forEach(this.options.resolve || [], function (e, a) {
                n.push(a), t.push(angular.isString(e) ? p.get(e) : p.invoke(e))
            }), n.push("$template"), t.push(e), u.all(t).then(function (e) {
                var t = {};
        ...
        return{restrict: "EA", scope: {numPages: "=", currentPage: "=", maxSize: "=", onSelectPage: "&"}, controller: "PaginationController", templateUrl: "template/pagination/pagination.html", replace: !0, link: function (t, n, a) {
            ...
            t.$watch("numPages + currentPage + maxSize", function () {
                ...
                if (r) {
                    ...
                    t.pages.unshift(h);
                    var v = o(t.currentPage + 1, u, !1, t.noNext());
                    t.pages.push(v)
                }
                if (i) {
                    var $ = o(1, l, !1, t.noPrevious());
                    t.pages.unshift($);
                    var b = o(t.numPages, c, !1, t.noNext());
                    t.pages.push(b)
                }
    ...
    this.options = function (e) {
        ...
        angular.extend(n, e)
    }, this.$get = ["$window", "$compile", "$timeout", "$parse", "$document", "$position", "$interpolate", function (o, i, r, l, s, u, c) {
        return function (o, p, d) {
            function f(e) {
                var t, a;
                return t = e || m.trigger || d, a = angular.isDefined(m.trigger) ? n[m.trigger] || t : n[t] || t, {show: t, hide: a}
            }

            var m = angular.extend({}, t, a), g = e(o), h = f(void 0), v = c.startSymbol(), $ = c.endSymbol(), b = "<" + g + "-popup " + 'title="' + v + "tt_title" + $ + '" ' + 'content="' + v + "tt_content" + $ + '" ' + 'placement="' + v + "tt_placement" + $ + '" ' + 'animation="tt_animation()" ' + 'is-open="tt_isOpen"' + ">" + "</" + g + "-popup>";
            return{restrict: "EA", scope: !0, link: function (e, t, n) {
                ...
                function c() {
                    e.tt_popupDelay ? y = r(g, e.tt_popupDelay) : e.$apply(g)
                }
                ...
                function g() {
                    var n, a, o, i;
                    if (e.tt_content) {
                        switch ($ && r.cancel($), k.css({top: 0, left: 0, display: "block"}), x ? (w = w || s.find("body"), w.append(k)) : t.after(k), n = m.appendToBody ? u.offset(t) : u.position(t), a = k.prop("offsetWidth"), o = k.prop("offsetHeight"), e.tt_placement) {
                            case"mouse":
                                var l = u.mouse();
                                i = {top: l.y, left: l.x};
                                break;
                ...
                function v() {
                    e.tt_isOpen = !1, r.cancel(y), angular.isDefined(e.tt_animation) && e.tt_animation() ? $ = r(function () {
                        k.remove()
                    }, 500) : k.remove()
                }

                var $, y, w, k = i(b)(e), x = angular.isDefined(m.appendToBody) ? m.appendToBody : !1;
                e.tt_isOpen = !1, n.$observe(o, function (t) {
                    ...
                    t.unbind(h.show), t.unbind(h.hide), h = f(e), h.show === h.hide ? t.bind(h.show, a) : (t.bind(h.show, c), t.bind(h.hide, d))
    ...
    return function (e) {
        ...
        return{restrict: "EA", require: "ngModel", replace: !0, templateUrl: "template/timepicker/timepicker.html", scope: {model: "=ngModel"}, link: function (a, o, i) {
            function r() {
                ...
                return t ? (a.showMeridian && (12 === e && (e = 0), a.meridian === c[1] && (e += 12)), e) : void 0
            }

            function l() {
                var t = u.getHours();
                a.showMeridian && (t = 0 === t || 12 === t ? 12 : t % 12), a.hours = "h" === $ ? t : e(t), a.validHours = !0;
                var n = u.getMinutes();
                a.minutes = "m" === $ ? n : e(n), a.validMinutes = !0, a.meridian = a.showMeridian ? 12 > u.getHours() ? c[0] : c[1] : "", $ = !1
            }

            function s(e) {
                var t = new Date(u.getTime() + 6e4 * e);
                t.getDate() !== u.getDate() && t.setDate(t.getDate() - 1), u.setTime(t.getTime()), a.model = new Date(u)
            }

            var u = new Date, c = n.meridians, p = n.hourStep;
            ...
            i.minuteStep && a.$parent.$watch(t(i.minuteStep), function (e) {
                ...
                if (a.showMeridian = !!e, a.model)l(); else {
                    var t = new Date(u), n = r();
                    angular.isDefined(n) && t.setHours(n), a.model = new Date(t)
                }
            });
            var f = o.find("input"), m = f.eq(0), g = f.eq(1), h = angular.isDefined(i.mousewheel) ? a.$eval(i.mousewheel) : n.mousewheel;
            if (h) {
                var v = function (e) {
                    return e.originalEvent && (e = e.originalEvent), e.detail || e.wheelDelta > 0
                };
                m.bind("mousewheel", function (e) {
            ...
            a.readonlyInput = angular.isDefined(i.readonlyInput) ? a.$eval(i.readonlyInput) : n.readonlyInput, a.readonlyInput ? (a.updateHours = angular.noop, a.updateMinutes = angular.noop) : (a.updateHours = function () {
                var e = r();
                angular.isDefined(e) ? ($ = "h", null === a.model && (a.model = new Date(u)), a.model.setHours(e)) : (a.model = null, a.validHours = !1)
                ...
                e >= 0 && 60 > e ? ($ = "m", null === a.model && (a.model = new Date(u)), a.model.setMinutes(e)) : (a.model = null, a.validMinutes = !1)
        ...
        var l = [9, 13, 27, 38, 40];
        return{require: "ngModel", link: function (s, u, c, p) {
            var d, f = s.$eval(c.typeaheadMinLength) || 1, m = s.$eval(c.typeaheadWaitMs) || 0, g = r.parse(c.typeahead), h = s.$eval(c.typeaheadEditable) !== !1, v = t(c.typeaheadLoading).assign || angular.noop, $ = t(c.typeaheadOnSelect), b = angular.element("<typeahead-popup></typeahead-popup>");
            b.attr({matches: "matches", active: "activeIdx", select: "select(activeIdx)", query: "query", position: "position"});
            var y = s.$new();
            ...
            var w = function () {
                ...
                var t = {$viewValue: e};
                v(s, !0), n.when(g.source(y, t)).then(function (n) {
                    if (e === p.$viewValue) {
                        if (n.length > 0) {
                            y.activeIdx = 0, y.matches.length = 0;
                            for (var a = 0; n.length > a; a++)t[g.itemName] = n[a], y.matches.push({label: g.viewMapper(y, t), model: n[a]});
                            y.query = e, y.position = i.position(u), y.position.top = y.position.top + u.prop("offsetHeight")
                        } else w();
                        v(s, !1)
                    }
                }, function () {
            ...
            w(), y.query = void 0, p.$parsers.push(function (e) {
                var t;
                return w(), d ? e : (e && e.length >= f && (m > 0 ? (t && a.cancel(t), t = a(function () {
                    k(e)
                }, m)) : k(e)), h ? e : void 0)
            }), p.$render = function () {
                var e = {};
                e[g.itemName] = d || p.$viewValue, u.val(g.viewMapper(y, e) || p.$viewValue), d = void 0
            }, y.select = function (e) {
                var t, n, a = {};
                a[g.itemName] = n = d = y.matches[e].model, t = g.modelMapper(y, a), p.$setViewValue(t), p.$render(), $(y, {$item: n, $model: t, $label: g.viewMapper(y, a)}), u[0].focus()
